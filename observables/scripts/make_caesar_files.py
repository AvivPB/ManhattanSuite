...
parser.add_argument('--haloid', action='store', type=str, default='fof', choices=['fof', 'snap'],
...
parser.add_argument('--half_stellar_radius_property', action=argparse.BooleanOptionalAction, default=False,
