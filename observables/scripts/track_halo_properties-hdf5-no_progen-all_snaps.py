    ...
    with h5py.File(args.output_file, 'r+') as f:
        ...
        if True:
            ...
            try:
                ...
                print(f'Bad {halo_type} id')
                append_to_dataset(group, 'id', -1, curr_length)
            ...
            try:
                ...
                print(f'Bad {halo_type} contamination')
                append_to_dataset(group, 'contamination', np.nan, curr_length)
            ...
            for ii, coord in zip([0,1,2], ['x', 'y', 'z']):
                for unit, suffix in zip(['', 'cm'], ['phys', 'cm']):
                    ...
                    try:
                        ...
                        print(f'Bad {halo_type} minpotpos_{coord}_{suffix}')
                        append_to_dataset(group, f'minpotpos_{coord}_{suffix}', np.nan, curr_length)
                    ...
                    try:
                        ...
                        print(f'Bad {halo_type} compos_{coord}_{suffix}')
                        append_to_dataset(group, f'compos_{coord}_{suffix}', np.nan, curr_length)
                ...
                for part_type in part_types:
                    ...
                    if part_type == 'PartType5':
                        ...
                        try:
                            ...
                            del bh_mass, bh_mdot, bh_mdot_acc, bh_mdot_edd, bh_fedd
            ...
            for delta_value in delta_values:
                ...
                try:
                    ...
                    print(f'Bad {halo_type} m{delta_value}c')
                    append_to_dataset(group, f'm{delta_value}c', 0, curr_length)
                ...
                try:
                    ...
                    print(f'Bad {halo_type} r{delta_value}c')
                    append_to_dataset(group, f'r{delta_value}c', 0, curr_length)
                ...
                try:
                    ...
                    print(f'Bad {halo_type} r{delta_value}c_cm')
                    append_to_dataset(group, f'r{delta_value}c_cm', 0, curr_length)
            ...
            for quant in virial_quantities:
                ...
                try:
                    ...
                    print(f'Bad {halo_type} {quant}')
                    append_to_dataset(group, f'{quant}', np.nan, curr_length)
            ...
            try:
                ...
                print(f'Bad {halo_type} num_major_mergers_cm')
                append_to_dataset(group, f'num_major_mergers_cm', np.nan, curr_length)
