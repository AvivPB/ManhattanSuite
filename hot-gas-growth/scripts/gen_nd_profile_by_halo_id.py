...
## Definitions for gas phases
gas_phases = {
    'cold':pnb.filt.LowPass('T', '3e4 K') & ~pnb.filt.HighPass('DelayTime', 0),
    'warm':pnb.filt.HighPass('T', '3e4 K') & pnb.filt.LowPass('T', '1e5 K') & ~pnb.filt.HighPass('DelayTime', 0),
    'warm-hot':pnb.filt.HighPass('T', '1e5 K') & pnb.filt.LowPass('T', '1e6 K') & ~pnb.filt.HighPass('DelayTime', 0),
    'hot':pnb.filt.HighPass('T', '1e6 K') & pnb.filt.LowPass('T', '1e7 K') & ~pnb.filt.HighPass('DelayTime', 0),
    'very-hot':pnb.filt.HighPass('T', '1e7 K') & ~pnb.filt.HighPass('DelayTime', 0),
}
